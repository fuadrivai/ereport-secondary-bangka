...
class Set_kd extends CI_Controller {
    ...
    public function simpan() {
        ...
        if ($p['_mode'] == "add") {
            ...
            $this->db->query("UPDATE t_mapel_kd SET id_mapel = '".$p['id_mapel']."',id_guru = '".$this->d['admkonid']."', tingkat = '".$p['tingkat']."', no_kd = '".$p['kode']."', jenis = '".$p['jenis']."', mid_final = '".$p['semester']."', nama_kd = '".addslashes($p['nama'])."' WHERE id = '".$p['_id']."'");
