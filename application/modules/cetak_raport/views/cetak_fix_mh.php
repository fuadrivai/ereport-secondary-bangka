<page backtop="7mm" backbottom="17mm" backleft="25mm" backimg="https://report.mhis.link/images/hanya_logo_op.png" backimgw="50%">
    ...
    <page backtop="7mm" backbottom="17mm" backleft="25mm" backimg="https://report.mhis.link/images/hanya_logo_op.png" backimgw="50%">
        ...
        <table>
            <tr>
                <td style="width:640px;padding: 10px 5px;text-align: justify;"><?= $catatan_ht ?? "--"; ?></td>
            </tr>
        </table>
        <div class="blue-line" style="width:660px;border-top: 1px #0162b1;"></div>
        <br><br>
        <table>
            <tr>
                <td style="width:450px">
                    ...
                    <?php if (($tingkat ?? 0) != 9) {
                    ?>
                        <?= $this->config->item('kota'); ?>, <?= isset($tgl_rapor) ? tjs($tgl_rapor, "l") : "--"; ?><br>
                    <?php } else { ?>
                        <?= $this->config->item('kota'); ?>, <?= tjs($tgl_rapor, "l"); ?><br>
                    <?php } ?>
                    <br><br><br><br>
