<div class="row">
    ...
    <div class="col-md-12">
        <div class="alert alert-warning" style="color: #000">
            <b>Petunjuk : </b><br>
            <ul>
                <li>Menu ini digunakan untuk menginput nilai pengetahuan pada mata pelajaran <b><i>
                            <?php echo $detil_mp['nmmapel'] . ", kelas " . $detil_mp['nmkelas']; ?>.
                        </i></b> </li>
                <li>Jika kompetensi dasar belum ada, silakan klik tombol <b><i>Tambah Topik</i></b>. Untuk mengubah atau
    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-body">
                <a href="<?php echo base_url(); ?>view_mapel" class="btn btn-info"><i class="fa fa-arrow-left"></i>
                    Kembali</a>
                <a href="<?php echo base_url(); ?>n_preschool/cetak/<?php echo $detil_mp['id_mapel'] . "-" . $detil_mp['id_kelas']; ?>"
                    class="btn btn-warning" target="_blank"><i class="fa fa-print"></i> Cetak</a>

                <a href="<?php echo base_url(); ?>n_preschool/import/<?php echo $detil_mp['id_mapel'] . "-" . $detil_mp['id_kelas']; ?>"
                    class="btn btn-danger"><i class="fa fa-download"></i> Download File Excel</a>
                <a href="<?php echo base_url(); ?>n_preschool/upload/<?php echo $detil_mp['id_mapel'] . "-" . $detil_mp['id_kelas']; ?>"
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="header">
                <h5 class="title">Nilai &raquo;
                    <?php echo $detil_mp['nmmapel'] . " - " . $detil_mp['nmkelas']; ?>
                </h5>
            </div>
            <div class="content">
                <p>
                    <a href="#" onclick="return edit(0);" class="btn btn-info"><i class="fa fa-plus-circle"></i> Tambah
                        Topik</a>
                </p>
            ...
            <form class="form-horizontal" method="post" id="<?php echo $nama_form; ?>" name="<?php echo $nama_form; ?>"
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="semester" class="form-control" autofocus="true" id="semester"
                                required>
                            <!--<p style="color: red; font-size: 10pt">DILARANG memakai spasi, koma, strip. Contoh : K01</p>-->
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    function view_kd(id, kelas, jenis = 'h') {
        ...
        if (id == 0 && kelas == 0) {
            ...
            $.getJSON(base_url + "<?php echo $url; ?>/ambil_siswa/" + kelas + "/" + id + "/" + jenis, function (data) {
                ...
                if (jenis == 'c') {
                    html = '<table class="table table-condensed table-bordered table-hover"><thead><tr><th width="5%">No</th><th width="15%">Nama</th><th width="35%">Progress</th><th width="35%">Need to Improve</th></tr></thead><tbody>';
                    var i = 1;
    ...
    function list_kd() {
        $.ajax({
            type: "GET",
            url: base_url + "n_preschool/list_kd/" + id_guru_mapel,
            beforeSend: function () {
