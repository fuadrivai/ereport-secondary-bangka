        ...
        <div class="card">
            ...
            <div class="content">
                ...
                <ul class="list-group" id="list_kd">
                    ...
                    <li class="list-group-item" onclick="return view_kd(<?php echo $detil_mp['id_mapel'].", ".$detil_mp['id_kelas']; ?>,'p');"><a href="#"><i class="fa fa-chevron-right"></i>  NILAI PRAKTIK</a></li>
