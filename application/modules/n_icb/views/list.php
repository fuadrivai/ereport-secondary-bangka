    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                <a href="<?php echo base_url(); ?>n_icb/import/<?php echo $detil_mp['id_mapel']."-".$detil_mp['id_kelas']; ?>" class="btn btn-danger"><i class="fa fa-download"></i> Download File Excel</a>
                <a href="<?php echo base_url(); ?>n_icb/upload/<?php echo $detil_mp['id_mapel']."-".$detil_mp['id_kelas']; ?>" class="btn btn-success"><i class="fa fa-upload"></i> Upload File Excel</a>
            </div>
        </div>
    </div>
    <div class="col-md-5">
        <div class="card">
            <div class="header">
                <h5 class="title">Nilai &raquo; <?php echo $detil_mp['nmmapel']." - ".$detil_mp['nmkelas']; ?></h5>
            </div>
            <div class="content">
                <p>
...
<script type="text/javascript">
    ...
    function list_kd() {
        $.ajax({
            type: "GET",
            url: base_url+"n_icb/list_kd/"+id_guru_mapel,
            beforeSend: function() {
