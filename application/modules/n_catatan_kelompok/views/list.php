    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                <a href="<?php echo base_url(); ?>n_catatan_kelompok/import/<?php echo  $id_kelas; ?>/<?php echo  $id_kelompok; ?>"
                    class="btn btn-danger"><i class="fa fa-download"></i> Download File Excel</a>
                <a href="<?php echo base_url(); ?>n_catatan_kelompok/upload/<?php echo  $id_kelas; ?>/<?php echo  $id_kelompok; ?>"
        ...
        <div class="card">
            <div class="header"><?php
                foreach ($nama_projek as $n_p) {
                    ?>
                <h4 class="title"><?php echo  $n_p['nama']; ?> Notes</h4>
                <? } ?>
            </div>
    ...
    $(document).on("ready", function () {
        ...
        $("#<?php echo $url; ?>").on("submit", function () {
            ...
            $.ajax({
                type: "POST",
                data: data,
                url: base_url + "<?php echo $url; ?>/simpan/<?php echo $id_kelompok; ?>",
                beforeSend: function () {
