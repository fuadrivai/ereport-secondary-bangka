                                    ...
                                    <?php if (!empty($siswa_kelas)) { ?>
                                        <?php for ($j = 0; $j < count($siswa_kelas); $j++) { ?>
                                            ...
                                            <?php if ($_th == $sk['ta']) { ?>
                                                ...
                                                <?php if ($tglmid <= $today) { ?>
                                                    <a href="https://report.mhis.link/bangka/secondary/cetak_raport_pts/cetak_ikm/<?php echo $sk['id_siswa']."/".$th['tahun']; ?>" class="btn btn-success btn-sm" target="_blank"><i class="fa fa-print"></i> Midterm Report</a>
                                                <?php } else{?>
                                                <a href="https://report.mhis.link/bangka/secondary/cetak_raport_pts/cetak/<?php echo $sk['id_siswa']."/".$th['tahun']; ?>" class="btn btn-success btn-sm" target="_blank"><i class="fa fa-print"></i> Midterm Report</a>
                                                <?php } ?>
                                                <?php if ($tglfinal <= $today) { ?>
                                                    <?php if ($bool) { ?>
                                                         <a href="https://report.mhis.link/bangka/secondary/cetak_raport/cetak/<?php echo $sk['id_siswa']."/".$th['tahun']; ?>" class="btn btn-success btn-sm" target="_blank"><i  class="fa fa-print"></i> Diknas Report</a>
                                                         <a href="https://report.mhis.link/bangka/secondary/cetak_raport/cetak_mh/<?php echo $sk['id_siswa']."/".$th['tahun']; ?>" class="btn btn-success btn-sm" target="_blank"><i  class="fa fa-print"></i> Final Report</a>
