<div class="row">
    ...
    <div class="col-md-12">
        <div class="alert alert-warning" style="color: #000">
            <b>Petunjuk : </b><br>
            <ul>
                <li>Menu ini digunakan untuk menginput nilai indikator projek <b><i><?php echo $detil_mp['nmmapel'].", kelas ".$detil_mp['nmkelas']; ?>.</i></b> </li>
                <li>Jika sub indikator belum ada, silakan klik tombol <b><i>Tambah Indikator</i></b>. Untuk mengubah atau menghapus nama sub Indikator, silakan klik tombol "<i class="fa fa-pencil"></i>" atau "<i class="fa fa-remove"></i>". </li>
                <li>Untuk mengisikan nilai indikator projek pada masing-masing Sub, silakan klik nama Sub Indikator, dan akan muncul daftar siswa serta isian nilai. Nilai dalam <b><i>skala 1-4</i></b>. Jangan lupa klik tombol <b><i>Simpan</i></b> di sebelah bawah.</li>
            </ul>
        </div>
    </div>
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-body">
                <a href="<?php echo base_url(); ?>view_kelompok" class="btn btn-info"><i class="fa fa-arrow-left"></i> Kembali</a>
                <a href="<?php echo base_url(); ?>n_kelompok/cetak/<?php echo $detil_mp['id_kelompok']."-".$detil_mp['id_kelas']; ?>" class="btn btn-warning" target="_blank"><i class="fa fa-print"></i> Cetak</a>

                <a href="<?php echo base_url(); ?>n_kelompok/import/<?php echo $detil_mp['id_kelompok']."-".$detil_mp['id_kelas']; ?>" class="btn btn-danger"><i class="fa fa-download"></i> Download File Excel</a>
                <a href="<?php echo base_url(); ?>n_kelompok/upload/<?php echo $detil_mp['id_kelompok']."-".$detil_mp['id_kelas']; ?>" class="btn btn-success"><i class="fa fa-upload"></i> Upload File Excel</a>
            </div>
        </div>
    </div>
    <div class="col-md-12">
        <div class="card">
            <div class="header">
                <h5 class="title">Nilai <?php if ($detil_mp['tingkat'] == '1' || $detil_mp['tingkat'] == '4'){ ?>Indikator <?php }else{ ?> Pengetahuan <?php } ?> &raquo; <?php echo $detil_mp['nmmapel']." - ".$detil_mp['nmkelas']; ?></h5>
            </div>
            <div class="content">
                <p>
                    <a href="#" onclick="return edit(0);" class="btn btn-info"><i class="fa fa-plus-circle"></i> Tambah Indikator</a>
                </p>
        ...
        <div class="card">
            ...
            <div class="content">
                <form name="f_input_nilai" method="post" action="#" id="f_input_nilai">
                    ...
                    <input type="hidden" name="id_kelompok_kd" id="id_kelompok_kd" value="">
...
<div class="modal" id="modal_data">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <input type="hidden" name="id_kelompok" id="id_kelompok" value="<?php echo $detil_mp['id_kelompok']; ?>">
...
<script type="text/javascript">
    ...
    function edit(id) {
        ...
        $.ajax({
            type: "GET",
            url: base_url+"set_kd_kelompok/edit/"+id,
            success: function(data) {
                $("#_id").val(data.data.id);
                $("#mapel").val(data.data.id_kelompok+"-"+data.data.tingkat);
    ...
    function hapus(id) {
        if (id == 0) {
            ...
            if (confirm('Anda yakin...?')) {
                $.ajax({
                    type: "GET",
                    url: base_url+"set_kd_kelompok/hapus/"+id,
                    success: function(data) {
    ...
    function simpan_kd() {
        var data    = $("#f_setkelompok").serialize();
    
        $.ajax({
            type: "POST",
            data: data,
            url: base_url+"set_kd_kelompok/simpan",
            beforeSend: function(){
    ...
    function list_kd() {
        $.ajax({
            type: "GET",
            url: base_url+"n_kelompok/list_kd/"+id_guru_mapel,
            beforeSend: function() {
