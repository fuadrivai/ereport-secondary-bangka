<div class="row">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <a href="<?php echo base_url(); ?>view_mapel" class="btn btn-info"><i class="fa fa-arrow-left"></i>
                    Kembali</a>
                <a href="<?php echo base_url(); ?>n_pengetahuan/cetak/<?php echo $detil_mp['id_mapel'] . "-" . $detil_mp['id_kelas']; ?>"
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="header">
                <h5 class="title">Nilai
                    <?php if ($detil_mp['tingkat'] == '7' || $detil_mp['tingkat'] == '10') { ?>Sumatif
                    <?php } else { ?> Pengetahuan
                    <?php } ?> &raquo;
            ...
            <div class="content">
                ...
                <ul class="list-group" id="list_kd">
                    ...
                    <li class="list-group-item"
                        ...
                        <a href="#"><i class="fa fa-chevron-right"></i> ULANGAN TENGAH SEMESTER</a></li>
                    <li class="list-group-item"
                        onclick="return view_kd(<?php echo $detil_mp['id_mapel'] . ", " . $detil_mp['id_kelas']; ?>,'a');">
                        <a href="#"><i class="fa fa-chevron-right"></i> ULANGAN AKHIR SEMESTER</a></li>
                    <li class="list-group-item"
